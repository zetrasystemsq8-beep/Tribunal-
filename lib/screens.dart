...
// ============================================================================
// DARK BRAND PALETTE (used app-wide)
// ============================================================================
...
// ============================================================================
// REVIEW FORM SCREEN — fixed reversed-text bug (see _ReviewFormScreenState)
// ============================================================================
...
class _ReviewFormScreenState extends ConsumerState<ReviewFormScreen> {
  ...
  // Persistent controllers created ONCE. Previously each text field
  // built a brand-new TextEditingController on every rebuild using the
  // latest saved value — that reset the cursor to position 0 on every
  // keystroke, so new characters kept inserting before existing ones
  // ("good" became "doog"). Keeping one stable controller per field
  // fixes it.
  late final TextEditingController strengthsController;
  late final TextEditingController weaknessesController;
  late final TextEditingController risksController;
  late final TextEditingController requiredChangesController;
  ...
  void initState() {
    ...
    strengthsController = TextEditingController(text: initial.strengths);
    weaknessesController = TextEditingController(text: initial.weaknesses);
    risksController = TextEditingController(text: initial.risks);
    requiredChangesController =
        TextEditingController(text: initial.requiredChanges);
  }
  ...
  void dispose() {
    ...
    requiredChangesController.dispose();
    super.dispose();
  }
        ...
        child: Column(
          ...
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Slider(
                      ...
                      divisions: 100,
                      onChanged: (val) {
                        _updateScore(key, val.toInt(), notifier);
                      },
                    ),
                  ],
                ),
            ...
            _ReviewTextField(
              ...
              onChanged: notifier.setStrengths,
            ),
            const SizedBox(height: AppSpacing.lg),
            _ReviewTextField(
              label: 'Weaknesses',
              ...
              onChanged: notifier.setWeaknesses,
            ),
            const SizedBox(height: AppSpacing.lg),
            _ReviewTextField(
              label: 'Risks',
            ...
            _ReviewTextField(
              ...
              controller: requiredChangesController,
              onChanged: notifier.setRequiredChanges,
              required: false,
            ),
            const SizedBox(height: AppSpacing.lg),
            Text(
            ...
            ...ReviewDimensions.recommendations.map((rec) {
              return Padding(
                ...
                child: GestureDetector(
                  onTap: () => notifier.setRecommendation(rec),
                  child: Container(
                    padding: const EdgeInsets.all(AppSpacing.md),
                    decoration: BoxDecoration(
                    ...
                    child: Row(
                      children: [
                        Radio<String>(
                          ...
                          onChanged: (val) {
                            if (val != null) {
                              notifier.setRecommendation(val);
                            }
                          },
                        ),
  ...
  void _updateScore(String key, int value, ReviewFormNotifier notifier) {
    switch (key) {
      case 'originality':
